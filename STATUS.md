...
- Publication status: `publication_queued` — 2026-07-30 Trackio publish to the shortened target hit HF HTTP 429 Space-creation quota after trace/bucket uploads may have succeeded. No retry before the reported ~24-hour reset; verify remote Space/dataset/bucket existence before any retry. Local official validator passed (`outputs/official_validator_publish_target.log`); publish error is retained in `outputs/trackio_publish_short_target.log`; approved public Git commit before attempted publish: `17901127d3dcce706f3482bc726fd87d349b5cc2`.
